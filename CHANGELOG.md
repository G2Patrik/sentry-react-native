...
- Bump CLI from v1.74.4 to v2.50.2 ([#131](https://github.com/G2Patrik/sentry-react-native/pull/131))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2502)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.50.2)
