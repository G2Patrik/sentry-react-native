...
- Bump CLI from v1.74.4 to v3.7.0 ([#291](https://github.com/G2Patrik/sentry-react-native/pull/291))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#370)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.7.0)
