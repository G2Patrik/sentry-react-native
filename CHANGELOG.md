...
- Bump Android SDK from v6.3.1 to v8.33.0 ([#211](https://github.com/G2Patrik/sentry-react-native/pull/211))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8330)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.33.0)
