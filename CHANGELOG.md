...
- Bump CLI from v1.74.4 to v2.42.5 ([#85](https://github.com/G2Patrik/sentry-react-native/pull/85))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2425)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.42.5)
