...
- Bump CLI from v1.74.4 to v3.2.1 ([#213](https://github.com/G2Patrik/sentry-react-native/pull/213))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#321)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.2.1)
