...
- Bump CLI from v1.74.4 to v3.0.1 ([#195](https://github.com/G2Patrik/sentry-react-native/pull/195))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#301)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.0.1)
