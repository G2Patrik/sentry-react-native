...
- Bump CLI from v1.74.4 to v3.1.0 ([#200](https://github.com/G2Patrik/sentry-react-native/pull/200))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#310)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.1.0)
