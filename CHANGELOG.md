...
- Bump Android SDK from v6.3.1 to v8.17.0 ([#126](https://github.com/G2Patrik/sentry-react-native/pull/126))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8170)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.17.0)
