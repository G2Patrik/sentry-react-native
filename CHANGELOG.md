...
- Bump CLI from v1.74.4 to v2.47.1 ([#128](https://github.com/G2Patrik/sentry-react-native/pull/128))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2471)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.47.1)
