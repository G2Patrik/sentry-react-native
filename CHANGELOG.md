...
- Bump CLI from v1.74.4 to v2.51.0 ([#137](https://github.com/G2Patrik/sentry-react-native/pull/137))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2510)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.51.0)
