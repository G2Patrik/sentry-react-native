...
- Bump CLI from v1.74.4 to v3.5.0 ([#252](https://github.com/G2Patrik/sentry-react-native/pull/252))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#350)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.5.0)
