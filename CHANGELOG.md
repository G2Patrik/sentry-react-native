...
- Bump Android SDK from v6.3.1 to v8.13.3 ([#117](https://github.com/G2Patrik/sentry-react-native/pull/117))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8133)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.13.3)
