...
- Bump Android SDK from v6.3.1 to v8.40.0 ([#239](https://github.com/G2Patrik/sentry-react-native/pull/239))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8400)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.40.0)
