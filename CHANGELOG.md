...
- Bump CLI from v1.74.4 to v2.44.0 ([#102](https://github.com/G2Patrik/sentry-react-native/pull/102))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2440)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.44.0)
