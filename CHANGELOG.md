...
- Bump Android SDK from v6.3.1 to v8.50.1 ([#278](https://github.com/G2Patrik/sentry-react-native/pull/278))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8501)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.50.1)
