...
- Bump Android SDK from v6.3.1 to v8.8.0 ([#91](https://github.com/G2Patrik/sentry-react-native/pull/91))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#880)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.8.0)
