...
- Bump CLI from v1.74.4 to v3.3.0 ([#221](https://github.com/G2Patrik/sentry-react-native/pull/221))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#330)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.3.0)
