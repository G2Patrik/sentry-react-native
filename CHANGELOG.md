...
- Bump CLI from v1.74.4 to v2.36.4 ([#20](https://github.com/G2Patrik/sentry-react-native/pull/20))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2364)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.36.4)
