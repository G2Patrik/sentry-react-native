...
- Bump CLI from v1.74.4 to v2.47.0 ([#124](https://github.com/G2Patrik/sentry-react-native/pull/124))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2470)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.47.0)
