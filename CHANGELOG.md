...
- Bump CLI from v1.74.4 to v2.38.0 ([#29](https://github.com/G2Patrik/sentry-react-native/pull/29))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2380)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.38.0)
