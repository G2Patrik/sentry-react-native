...
- Bump Android SDK from v6.3.1 to v8.39.1 ([#237](https://github.com/G2Patrik/sentry-react-native/pull/237))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8391)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.39.1)
