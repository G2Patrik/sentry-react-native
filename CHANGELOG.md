...
- Bump Android SDK from v6.3.1 to v8.24.0 ([#169](https://github.com/G2Patrik/sentry-react-native/pull/169))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8240)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.24.0)
