...
- Bump Android SDK from v6.3.1 to v8.35.0 ([#226](https://github.com/G2Patrik/sentry-react-native/pull/226))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8350)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.35.0)
