...
- Bump CLI from v1.74.4 to v3.0.0 ([#192](https://github.com/G2Patrik/sentry-react-native/pull/192))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#300)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.0.0)
