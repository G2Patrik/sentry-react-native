...
- Bump Android SDK from v6.3.1 to v8.37.1 ([#231](https://github.com/G2Patrik/sentry-react-native/pull/231))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8371)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.37.1)
