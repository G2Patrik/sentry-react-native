...
- Bump Android SDK from v6.3.1 to v8.41.0 ([#244](https://github.com/G2Patrik/sentry-react-native/pull/244))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8410)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.41.0)
