...
- Bump CLI from v1.74.4 to v2.50.0 ([#130](https://github.com/G2Patrik/sentry-react-native/pull/130))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2500)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.50.0)
