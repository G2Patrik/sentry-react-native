...
- Bump Android SDK from v6.3.1 to v8.43.1 ([#253](https://github.com/G2Patrik/sentry-react-native/pull/253))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8431)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.43.1)
