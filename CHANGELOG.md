...
- Bump Android SDK from v6.3.1 to v8.52.0 ([#283](https://github.com/G2Patrik/sentry-react-native/pull/283))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8520)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.52.0)
