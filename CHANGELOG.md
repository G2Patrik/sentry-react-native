...
- Bump CLI from v1.74.4 to v3.4.1 ([#241](https://github.com/G2Patrik/sentry-react-native/pull/241))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#341)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.4.1)
