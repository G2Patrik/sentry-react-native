...
- Bump CLI from v1.74.4 to v2.37.0 ([#24](https://github.com/G2Patrik/sentry-react-native/pull/24))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2370)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.37.0)
