...
- Bump Android SDK from v6.3.1 to v8.10.0 ([#96](https://github.com/G2Patrik/sentry-react-native/pull/96))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8100)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.10.0)
