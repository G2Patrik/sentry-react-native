...
- Bump Android SDK from v6.3.1 to v8.21.1 ([#152](https://github.com/G2Patrik/sentry-react-native/pull/152))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8211)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.21.1)
