...
- Bump CLI from v1.74.4 to v2.36.2 ([#16](https://github.com/G2Patrik/sentry-react-native/pull/16))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2362)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.36.2)
