...
- Bump Android SDK from v6.3.1 to v8.43.2 ([#255](https://github.com/G2Patrik/sentry-react-native/pull/255))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8432)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.43.2)
