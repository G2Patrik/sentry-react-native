...
- Bump Android SDK from v6.3.1 to v8.50.0 ([#276](https://github.com/G2Patrik/sentry-react-native/pull/276))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8500)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.50.0)
