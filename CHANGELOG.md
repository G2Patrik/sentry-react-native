...
- Bump CLI from v1.74.4 to v3.8.0 ([#297](https://github.com/G2Patrik/sentry-react-native/pull/297))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#380)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.8.0)
