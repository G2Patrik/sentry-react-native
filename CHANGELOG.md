...
- Bump Android SDK from v6.3.1 to v8.0.0 ([#57](https://github.com/G2Patrik/sentry-react-native/pull/57))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#800)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.0.0)
