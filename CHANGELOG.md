...
- Bump Android SDK from v6.3.1 to v8.34.0 ([#220](https://github.com/G2Patrik/sentry-react-native/pull/220))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8340)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.34.0)
