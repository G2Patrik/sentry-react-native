...
- Bump Android SDK from v6.3.1 to v8.15.1 ([#121](https://github.com/G2Patrik/sentry-react-native/pull/121))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8151)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.15.1)
