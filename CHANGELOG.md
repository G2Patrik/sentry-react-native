...
- Bump Android SDK from v6.3.1 to v8.12.0 ([#106](https://github.com/G2Patrik/sentry-react-native/pull/106))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8120)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.12.0)
