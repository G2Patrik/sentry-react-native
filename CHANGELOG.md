...
- Bump Android SDK from v6.3.1 to v8.11.1 ([#100](https://github.com/G2Patrik/sentry-react-native/pull/100))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8111)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.11.1)
