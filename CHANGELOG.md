...
- Bump Wizard from v1.2.17 to v3.26.0 ([#4](https://github.com/G2Patrik/sentry-react-native/pull/4))
  - [changelog](https://github.com/getsentry/sentry-wizard/blob/master/CHANGELOG.md#v3260)
  - [diff](https://github.com/getsentry/sentry-wizard/compare/v1.2.17...v3.26.0)
