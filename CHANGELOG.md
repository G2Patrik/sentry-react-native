...
- Bump Android SDK from v6.3.1 to v8.7.0 ([#89](https://github.com/G2Patrik/sentry-react-native/pull/89))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#870)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.7.0)
