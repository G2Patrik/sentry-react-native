...
- Bump CLI from v1.74.4 to v2.42.3 ([#79](https://github.com/G2Patrik/sentry-react-native/pull/79))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2423)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.42.3)
