...
- Bump Android SDK from v6.3.1 to v8.36.0 ([#227](https://github.com/G2Patrik/sentry-react-native/pull/227))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8360)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.36.0)
