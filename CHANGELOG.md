...
- Bump CLI from v1.74.4 to v2.40.0 ([#53](https://github.com/G2Patrik/sentry-react-native/pull/53))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2400)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.40.0)
