...
- Bump CLI from v1.74.4 to v2.58.2 ([#178](https://github.com/G2Patrik/sentry-react-native/pull/178))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2582)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.58.2)
