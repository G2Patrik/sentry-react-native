...
- Bump Android SDK from v6.3.1 to v8.27.0 ([#180](https://github.com/G2Patrik/sentry-react-native/pull/180))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8270)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.27.0)
