...
- Bump CLI from v1.74.4 to v2.43.0 ([#86](https://github.com/G2Patrik/sentry-react-native/pull/86))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2430)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.43.0)
