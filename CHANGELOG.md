...
- Bump CLI from v1.74.4 to v2.56.1 ([#165](https://github.com/G2Patrik/sentry-react-native/pull/165))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2561)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.56.1)
