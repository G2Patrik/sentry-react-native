...
- Bump Wizard from v1.2.17 to v3.27.0 ([#9](https://github.com/G2Patrik/sentry-react-native/pull/9))
  - [changelog](https://github.com/getsentry/sentry-wizard/blob/master/CHANGELOG.md#v3270)
  - [diff](https://github.com/getsentry/sentry-wizard/compare/v1.2.17...v3.27.0)
