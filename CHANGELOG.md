...
- Bump Android SDK from v6.3.1 to v8.25.0 ([#171](https://github.com/G2Patrik/sentry-react-native/pull/171))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#8250)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.25.0)
