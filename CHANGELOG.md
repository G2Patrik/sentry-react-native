...
- Bump Android SDK from v6.3.1 to v8.4.0 ([#80](https://github.com/G2Patrik/sentry-react-native/pull/80))
  - [changelog](https://github.com/getsentry/sentry-java/blob/main/CHANGELOG.md#840)
  - [diff](https://github.com/getsentry/sentry-java/compare/6.3.1...8.4.0)
