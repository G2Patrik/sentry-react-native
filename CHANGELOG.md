...
- Bump CLI from v1.74.4 to v2.53.0 ([#148](https://github.com/G2Patrik/sentry-react-native/pull/148))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#2530)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...2.53.0)
