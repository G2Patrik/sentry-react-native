...
- Bump CLI from v1.74.4 to v3.6.0 ([#265](https://github.com/G2Patrik/sentry-react-native/pull/265))
  - [changelog](https://github.com/getsentry/sentry-cli/blob/master/CHANGELOG.md#360)
  - [diff](https://github.com/getsentry/sentry-cli/compare/1.74.4...3.6.0)
